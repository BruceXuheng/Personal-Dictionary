...
import com.zero.materialdesign.chen.one.Chen1Activity;
import com.zero.materialdesign.chen.two.Chen2Activity;
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        switch (position) {
            ...
            case 17://"NestedScrollViewActivity",//17
                ...
                startActivity(gotoAct);
                break;
            case 18://"NestedScrollViewActivity",//17
                gotoAct = new Intent(getActivity(), Chen1Activity.class);
                startActivity(gotoAct);
                break;
            case 19://"NestedScrollViewActivity",//17
                gotoAct = new Intent(getActivity(), Chen2Activity.class);
                startActivity(gotoAct);
                break;
            default:
                break;
