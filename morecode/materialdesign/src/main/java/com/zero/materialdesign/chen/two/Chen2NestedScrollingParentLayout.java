 ...
 * @Date: 2020/8/7
 */
public class Chen2NestedScrollingParentLayout extends LinearLayout implements NestedScrollingParent {
    ...
    public Chen2NestedScrollingParentLayout(Context context) {
        super(context);
    }

    public Chen2NestedScrollingParentLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public Chen2NestedScrollingParentLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        setOrientation(VERTICAL);
    }

    public Chen2NestedScrollingParentLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
