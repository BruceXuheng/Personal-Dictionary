 ...
 * @Date: 2020/7/30
 */
public class SlideTouchCallBack extends ItemTouchHelper.SimpleCallback {
    ...
    public SlideTouchCallBack(int dragDirs, int swipeDirs) {
        super(dragDirs, swipeDirs);
    }
    public SlideTouchCallBack(RecyclerView mRv,
